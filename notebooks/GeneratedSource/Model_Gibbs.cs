...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1912.403 at 10:17 on Wednesday, 03 February 2021.
	/// </remarks>
	public partial class Model_Gibbs : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_numberOfIterations has executed. Set this to false to force re-execution of Changed_numberOfIterations</summary>
		public bool Changed_numberOfIterations_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased</summary>
		public bool Changed_numberOfIterationsDecreased_isDone;
		...
		/// <summary>Computations that depend on the observed value of numberOfIterations</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_numberOfIterations(int numberOfIterations)
		{
			if (this.Changed_numberOfIterations_isDone) {
				return ;
			}
			...
			for(int iteration = this.numberOfIterationsDone; iteration<numberOfIterations; iteration++) {
				...
				bothHeads_F = Factor.And(firstCoin_uses_F[0], secondCoin_uses_F[0]);
			...
			this.Changed_numberOfIterations_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			if (numberOfIterations!=this.numberOfIterationsDone) {
				if (numberOfIterations<this.numberOfIterationsDone) {
					...
					this.Changed_numberOfIterationsDecreased_isDone = false;
				}
				this.Changed_numberOfIterations_isDone = false;
			}
			this.Constant();
			this.Changed_numberOfIterationsDecreased();
			this.Changed_numberOfIterations(numberOfIterations);
